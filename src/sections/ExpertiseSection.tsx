...
export function ExpertiseSection() {
  return (
    <section id="expertise" className="scroll-section section-shell flex items-center justify-center">
      <SectionRevealLayer className="max-w-6xl w-full flex flex-col h-full justify-center">
        <RevealGroup className="flex flex-col gap-6">
          <SectionHeader
            eyebrow="Synergie aus Design, Code & Data"
            title="Mein T-Shaped Profil"
            accent="violet"
          />
