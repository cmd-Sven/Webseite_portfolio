...
export function ContactSection() {
  return (
    <section id="contact" className="scroll-section flex items-center justify-center px-6 md:px-12 py-16">
      <SectionRevealLayer className="max-w-4xl w-full">
        ...
        <div className="w-full md:w-1/2 space-y-6">
          <div>
            ...
            <h2 className="heading-section section-heading-xl text-4xl font-extrabold tracking-tight mt-1">
              Lass uns über Synergien sprechen.
            </h2>
          </div>
